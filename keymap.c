...
[_PROGRAMMING] =
LAYOUT_ortho_4x12(
        KC_NO, KC_NO, S(KC_BSLS), S(KC_7), KC_EQUAL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        ...
        KC_NO, KC_NO, S(KC_F9), S(KC_F10), C(A(KC_L)), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
...
[_PC_CONTROL] =
LAYOUT_ortho_4x12(
        RESET, DYN_REC_STOP, DYN_REC_START1, DYN_MACRO_PLAY1, KC_NO, KC_NO, KC_NO, A(KC_F4), LWIN(KC_L), LWIN(KC_K), LWIN(KC_R), KC_NO,
